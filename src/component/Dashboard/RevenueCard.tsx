export default function RevenueCard() {
  return (
    <div className="relative overflow-hidden rounded-4xl w-auto text-slate-400 bg-blue-950 dark:bg-slate-900/70 p-5 py-8 flex flex-col gap-4 place-items-center shadow-xl">
